...
func (s service) CreateTransaction(ctx context.Context, req CreateTransactionRequestPayload) (err error) {
	...
	trx.FromProduct(myProduct).SetGrandTotal().SetPlatformFee(1_000)
...
func (s service) TransactionHistories(ctx context.Context, userPublicId string) (trx []Transaction, err error) {
	// ? Find transaction
