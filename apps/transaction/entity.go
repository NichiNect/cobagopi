...
const (
	...
	TransactionStatus_Process   TransactionStatus = 10
	TransactionStatus_Delivery  TransactionStatus = 15
	TransactionStatus_Completed TransactionStatus = 20

	TRX_CREATED   string = "CREATED"
	TRX_PROCESS   string = "PROCESS"
	TRX_DELIVERY  string = "DELIVERY"
...
var (
	MappingTransactionStatus = map[TransactionStatus]string{
		...
		TransactionStatus_Process:   TRX_PROCESS,
		TransactionStatus_Delivery:  TRX_DELIVERY,
...
func (t Transaction) ToTransactionHistoryTransform() TraansactionHistoryTransformer {
	product, err := t.GetProduct()
	if err != nil {
		product = Product{}
	}

	return TraansactionHistoryTransformer{
		Id:           t.Id,
